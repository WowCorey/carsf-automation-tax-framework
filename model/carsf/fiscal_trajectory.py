...
def _year_map(source: dict[Any, Any] | None, field_name: str) -> dict[int, float]:
    if source is None:
        return {}
    ...
    for key, value in source.items():
        year = int(key)
        mapped[year] = _non_negative_number(value, f"{field_name}[{year}]")
    return mapped
...
def _input_from_mapping(source: dict[str, Any]) -> FiscalTrajectoryInput:
    ...
    return FiscalTrajectoryInput(
        ...
        company_tax_change_by_year=_year_map(source.get("company_tax_change_by_year"), "company_tax_change_by_year"),
        gst_consumption_change_by_year=_year_map(source.get("gst_consumption_change_by_year"), "gst_consumption_change_by_year"),
        ...
        other_revenue_change_by_year=_year_map(source.get("other_revenue_change_by_year"), "other_revenue_change_by_year"),
