...
- Build 25 sealed the previous RC state. Builds 26-29.5 add new artefacts; if those artefacts become part of a later sealed RC, the final RC integrity seal must be regenerated rather than described as already covering them.
