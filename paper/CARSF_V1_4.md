...
**CARSF V1.4 - Treasury Exposure Draft (Pre-Consultation)**
...
CARSF V1.4 - Treasury Exposure Draft (Pre-Consultation). Prepared 12 May 2026. Supersedes V1.3 (12
...
cap prevent confiscatory outcomes. The Automation Rent Levy follows PRRT-style uplift logic, taxing only
...
PRRT-style rent levy applies, with a combined cap to prevent stacking.
...
Automation Rent Levy (ARL) Separate PRRT-style levy on above-normal automated returns, using an uplift rate above a
